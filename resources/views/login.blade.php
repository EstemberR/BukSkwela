    ...
    <div class="split-layout">
        ...
        <div class="form-side">
            <div class="auth-form-light p-5">
                ...
                <form method="POST" action="{{ function_exists('tenant') && tenant() ? route('tenant.login.post') : url('/login') }}" id="loginForm">
                    @csrf
        ...
        document.addEventListener('DOMContentLoaded', function() {
            ...
            loginForm.addEventListener('submit', function(e) {
                ...
                if (email.endsWith('@student.buksu.edu.ph')) {
                    ...
                    // For admins, instructors, and staff - preserve tenant context if present
                    @if(function_exists('tenant') && tenant())
                        // We're in tenant context, send to tenant login
                        loginForm.action = "{{ route('tenant.login.post') }}";
                    @else
                        // We're on the central domain
